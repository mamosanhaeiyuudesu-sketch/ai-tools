...
export const BATTER_STATS: StatMeta[] = [
  {
    key: 'avg', label: 'AVG',
    description: '打率（ヒット数÷打数）。高いほど良い。',
    direction: 'high',
    format: (v) => v === null ? '—' : v.toFixed(3),
  },
  {
    key: 'obp', label: 'OBP',
    description: '出塁率（安打・四球・死球で塁に出た割合）。高いほど良い。',
    direction: 'high',
    format: (v) => v === null ? '—' : v.toFixed(3),
  },
  {
    key: 'ops', label: 'OPS',
    description: '打撃総合力（出塁率＋長打率）。1.000以上が超一流。高いほど良い。',
    direction: 'high',
    format: (v) => v === null ? '—' : v.toFixed(3),
  },
  {
  ...
  {
    key: 'bbPct', label: 'BB%',
    description: '四球率（選球眼の指標）。高いほど良い。',
    direction: 'high',
    format: (v) => v === null ? '—' : (v as number).toFixed(1) + '%',
  },
  {
    key: 'kPct', label: 'K%',
    description: '三振率。低いほど良い。',
    direction: 'low',
    format: (v) => v === null ? '—' : (v as number).toFixed(1) + '%',
  },
  {
    key: 'war', label: 'WAR',
    description: '平均的な選手と比べた総合的な貢献度。高いほど良い。',
    direction: 'high',
    format: (v) => v === null ? '—' : (v as number).toFixed(1),
  },
]
...
export const PITCHER_STATS: StatMeta[] = [
  {
    key: 'era', label: 'ERA',
    description: '防御率（9イニングあたりの自責点）。低いほど良い。',
    direction: 'low',
    format: (v) => v === null ? '—' : (v as number).toFixed(2),
  },
  {
    key: 'fip', label: 'FIP',
    description: '守備を除いた純粋な投手力（ERA類似）。低いほど良い。',
    direction: 'low',
    format: (v) => v === null ? '—' : (v as number).toFixed(2),
  },
  {
    key: 'whip', label: 'WHIP',
    description: '1イニングあたりの出塁許容数（安打＋四球）。低いほど良い。',
    direction: 'low',
    format: (v) => v === null ? '—' : (v as number).toFixed(2),
  },
  {
    key: 'kPct', label: 'K%',
    description: '奪三振率。高いほど良い。',
    direction: 'high',
    format: (v) => v === null ? '—' : (v as number).toFixed(1) + '%',
  },
  {
    key: 'bbPct', label: 'BB%',
    description: '与四球率。低いほど良い。',
    direction: 'low',
    format: (v) => v === null ? '—' : (v as number).toFixed(1) + '%',
  },
  {
    key: 'gbPct', label: 'GB%',
    description: 'ゴロアウト率（ゴロで打ち取る割合）。高いほど良い。',
    direction: 'high',
    format: (v) => v === null ? '—' : (v as number).toFixed(1) + '%',
  },
  {
    key: 'war', label: 'WAR',
    description: '平均的な投手と比べた総合的な貢献度。高いほど良い。',
    direction: 'high',
    format: (v) => v === null ? '—' : (v as number).toFixed(1),
  },
]
